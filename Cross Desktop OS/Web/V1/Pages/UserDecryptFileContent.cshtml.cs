...
{
    public class UserDecryptFileContentModel : PageModel
    {
        ...
        public void OnPostGetFileContentCount()
        {
            ...
            if (RandomFileName.CompareTo("") != 0 && CurrentDirectoryID.CompareTo("") != 0)
            {
                ...
                try
                {
                    OriginalFileNameByte = System.IO.File.ReadAllBytes(RootDirectory + "/Other_Directory_Data/" + DirectoryIDTempStorage.DirectoryID + "/Encrypted_Files/" + RandomFileName + "/FileName.txt");
                }
                catch
                {
        ...
        public int GetFileContentCount(String DirectoryID, String RandomFileName, Byte[] RandomChallenge)
        {
            ...
            if (ETLSSessionIDStorage.ETLSID.CompareTo("") != 0 && ETLSSessionIDStorage.ETLSID != null)
            {
                ...
                UserECDSASK = System.IO.File.ReadAllBytes(RootDirectory + "/Other_Directory_Data/" + DirectoryID + "/SK.txt");
                AccessID = System.IO.File.ReadAllText(RootDirectory + "/Other_Directory_Data/" + DirectoryID + "/AccessID.txt");
                ...
                while (LoopCount <= Count)
                {
                    ...
                    if (Base64Challenge != null && Base64Challenge.CompareTo("") != 0)
                    {
                        ...
                        if (ServerFileContent.Length != 0)
                        {
                            try
                            {
                                Key = System.IO.File.ReadAllBytes(RootDirectory + "/Other_Directory_Data/" + DirectoryIDTempStorage.DirectoryID + "/Encrypted_Files/" + RandomFileName + "/Key/" + "Key" + LoopCount.ToString() + ".txt");
                            }
                            catch
                            {
                            ...
                            try
                            {
                                ED25519PK = System.IO.File.ReadAllBytes(RootDirectory + "/Other_Directory_Data/" + DirectoryIDTempStorage.DirectoryID + "/Encrypted_Files/" + RandomFileName + "/ED25519PK/" + "PK" + LoopCount.ToString() + ".txt");
                            }
                            catch
                            {
        ...
        {
            String RootDirectory = AppContext.BaseDirectory;
            String[] FileNamesFullPathArray = Directory.GetDirectories(RootDirectory + "/Other_Directory_Data/" + DirectoryIDTempStorage.DirectoryID + "/Encrypted_Files/");
            String[] FileNamesArray = new string[FileNamesFullPathArray.Length];
            int Count = 0;
            int RootDirectoryCount = 0;
            RootDirectoryCount = (RootDirectory + "/Other_Directory_Data/" + DirectoryIDTempStorage.DirectoryID + "/Encrypted_Files/").Length;
