...
{
    public partial class ImportInformationFromZip : Form
    {
        public ImportInformationFromZip()
        {
            InitializeComponent();
        }
        ...
        private void ImportBTN_Click(object sender, EventArgs e)
        {
            ...
            if (ZipFileChooser.FileName != null && ZipFileChooser.FileName.CompareTo("") != 0) 
            {
                if (ZipFileChooser.SafeFileName.Contains(".zip") == true) 
                {
                    ...
                    ZipFile.ExtractToDirectory(ZipFileChooser.FileName, Application.StartupPath + "\\Application_Data\\User\\" + UserIDTempStorage.UserID + "\\Server_Directory_Data\\");
