                    ...
                    while (LoopCount <= Count)
                    {
                        ...
                        if (Base64Challenge != null && Base64Challenge.CompareTo("") != 0)
                        {
                            ...
                            if (ServerFileContent.Length != 0)
                            {
                                try
                                {
                                    Key = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\Other_Directory_Data\\" + DirectoryIDTempStorage.DirectoryID + "\\Encrypted_Files\\" + EncryptedRandomFileNameCB.Text + "\\Key\\" + "Key" + LoopCount.ToString() + ".txt");
                                }
                                catch
                                {
                                ...
                                try
                                {
                                    ED25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\Other_Directory_Data\\" + DirectoryIDTempStorage.DirectoryID + "\\Encrypted_Files\\" + EncryptedRandomFileNameCB.Text + "\\ED25519PK\\" + "PK" + LoopCount.ToString() + ".txt");
                                }
                                catch
                                {
